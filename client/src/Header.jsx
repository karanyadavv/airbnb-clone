...
export default function Header(){
  return(
    ...
    <header className='py-4 px-10 flex justify-between border-b border-[#EBEBEB]-800'>
        ...
        <div className='flex items-center gap-4 border border-gray-300 rounded-full md:py-3 px-4 shadow-md shadow-gray-300 text-sm'>
          <div>Anywhere</div>
          <div className='border-l border-gray-300 h-6 sm:block'></div>
          <div>Any week</div>
          <div className='border-l border-gray-300 h-6 sm:block'></div>
